...
using SistemaAnimalDBFirst.Data;
using SistemaAnimalDBFirst.Models;

namespace SistemaAnimalDBFirst.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Som,TipoAlimentacao,Animal")] TabelaAnimal tabelaAnimal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Som,TipoAlimentacao,Animal")] TabelaAnimal tabelaAnimal)
        {
