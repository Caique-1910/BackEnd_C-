...
using SistemaJogoDBFirst.Data;
using SistemaJogoDBFirst.Models;

namespace SistemaJogoDBFirst.Controllers
{
    public class JogoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Nivel,Tipo")] TabelaJogo tabelaJogo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Nivel,Tipo")] TabelaJogo tabelaJogo)
        {
            if (id != tabelaJogo.Id)
            {
                return NotFound();
